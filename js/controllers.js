...
var homeControllers1 = angular.module('homeControllers', ['angularValidator','ngDialog','ngCookies','ngFileUpload','ngAnimate', 'ngTouch','uiGmapgoogle-maps','ngSanitize','com.2fdevs.videogular','youtube-embed','highcharts-ng','shoppinpal.mobile-menu','ui.bootstrap']);
	...
	$scope.postStatus = function(){
		if($scope.statusText || $scope.statusValue){
			$http({
					...
					data    : $.param({'msg':$scope.statusText,'share_with':$scope.shareVal,'group_id':$scope.group,'type':$scope.statusType,'value':$scope.statusValue,'is_status':1}),
					headers : { 'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8' } 
				}).success(function (result) {
					$scope.isStatusInput = 0;
					$scope.isRotateBtn = 0;
                        ...
                        onrendered: function(canvas) {
                            ...
                            $http({
                                ...
                                $http({
                                    method: 'POST',
                                    async:   false,
                                    url: $scope.baseUrl+'/user/profile/imageMerge',
                                    ...
                                    /*var obj = {
                                        ...
                                        link: 'http://torqkd.com/experience',
